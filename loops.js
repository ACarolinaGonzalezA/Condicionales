...
/* while (condicion) {
  ...
  //hace algo para que la condicion eventualmente se deje de cumplir, se termine cortando el while
} */
...
while (i <= final) {
  acumuladora += i; // acumuladora = acumulador + i
  i++;
}
...
/* 
  ...
  son muy útiles para recorrer un arreglo y mostrar todos sus elementos. 
  Sin embargo la sintaxis no es tan diferente del while y tampoco no es la única manera de recorrer un arreglo. */
